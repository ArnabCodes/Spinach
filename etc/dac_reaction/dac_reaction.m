...
inter_c.coupling.scalar(idxof(sys_c,'H14'), idxof(sys_c,'H13'))= 9.4;
...
inter_c.coupling.scalar(idxof(sys_c,'H10'), idxof(sys_c,'H16'))= 3.1; 
...
inter_d.coupling.scalar(idxof(sys_d,'H21'), idxof(sys_d,'H26'))= 1.1;   
inter_d.coupling.scalar(idxof(sys_d,'H21'), idxof(sys_d,'H27'))= 1.1;
inter_d.coupling.scalar(idxof(sys_d,'H22'), idxof(sys_d,'H23'))= 4.5; 
inter_d.coupling.scalar(idxof(sys_d,'H22'), idxof(sys_d,'H24'))= 8.5; 
inter_d.coupling.scalar(idxof(sys_d,'H22'), idxof(sys_d,'H21'))= 0.8;
